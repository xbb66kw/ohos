...
# 2. Metadata: Reordered to match dataset_name indices 0-18
dataset_meta = [
...
test_ = 'beta' # beta2' 'beta'
# beta uses s = 5, max_eval = 100, R = 20
# 'beta3' uses s = 5, max_eval = 70, R = 10
# 'beta4' uses s = 5, max_eval = 70, R = 10
